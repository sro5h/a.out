...
TEST id_pool_create(void) {
        aout_id_pool* pool = aout_id_pool_create(0x400);
        ...
        aout_id_pool_destroy(pool);

        PASS();
}

TEST id_pool_id_create_then_id_pool_id_is_valid(void) {
        aout_id_pool* pool = aout_id_pool_create(0xff);
        aout_id id = AOUT_ID_POOL_INVALID_ID;

        ASSERT(pool);

        aout_id id0 = aout_id_pool_id_create(pool);
        ...
        aout_id id1 = aout_id_pool_id_create(pool);
        ...
        for (size_t i = 2; i < 0xff; ++i) {
                id = aout_id_pool_id_create(pool);
...
TEST id_pool_id_create_then_id_pool_id_destroy(void) {
        aout_id_pool* pool = aout_id_pool_create(0xff);

        ASSERT(pool);

        aout_id id01 = aout_id_pool_id_create(pool);

        ASSERT_EQ(id01, 0x00000001);
        ASSERT(aout_id_pool_id_is_valid(pool, id01));

        aout_id_pool_id_destroy(pool, id01);

        ASSERT(!aout_id_pool_id_is_valid(pool, id01));

        aout_id id11 = aout_id_pool_id_create(pool);

        ASSERT_EQ(id11, 0x01000001);
        ASSERT(!aout_id_pool_id_is_valid(pool, id01));
        ASSERT(aout_id_pool_id_is_valid(pool, id11));

        aout_id id02 = aout_id_pool_id_create(pool);
        ...
        aout_id id03 = aout_id_pool_id_create(pool);
        ...
        aout_id_pool_id_destroy(pool, id03);
        ...
        aout_id id13 = aout_id_pool_id_create(pool);
        ...
        aout_id_pool_id_destroy(pool, id13);
        ...
        aout_id id23 = aout_id_pool_id_create(pool);
        ...
        aout_id_pool_id_destroy(pool, id02);
        ...
        aout_id id12 = aout_id_pool_id_create(pool);
...
SUITE(test_id_pool) {
        ...
        RUN_TEST(id_pool_create);
        RUN_TEST(id_pool_id_create_then_id_pool_id_is_valid);
        RUN_TEST(id_pool_id_create_then_id_pool_id_destroy);
}
